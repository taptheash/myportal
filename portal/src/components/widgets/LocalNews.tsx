...
const FEED_URL = 'https://www.unionleader.com/feed/';
...
export default function LocalNews({ config }: LocalNewsProps) {
  ...
  if (error) return <div className="flex flex-col items-center justify-center h-24 gap-2 text-green-600"><AlertCircle size={20} /><p className="text-xs text-center">{error}</p></div>;
